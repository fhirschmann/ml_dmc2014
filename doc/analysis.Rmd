...
### Attribute Type and # of Factor Levels
...
```{r}
dt.train$deliveryTime <- as.numeric(dt.train$deliveryDate - dt.train$orderDate)
dt.test$deliveryTime <- as.numeric(dt.test$deliveryDate - dt.test$orderDate)
```
