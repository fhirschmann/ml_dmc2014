...
and is hooked onto the SVN. So please don't break my server.
...
plot.ddens(dt.train$deliveryTime, dt.test$deliveryTime,
           main="Kernel Density Estimate of Delivery Time", xlab="price (EUR)")
plot.ddens(dt.train$deliveryTime, dt.test$deliveryTime, xlim=c(0, 40),
           main="Kernel Density Estimate of Delivery Time", xlab="price (EUR)")
```

This is interesting because the second spike in the red line is different from
the second spike in the blue line. The current working thesis is: Easter 2013
caused the delay in the test set.
