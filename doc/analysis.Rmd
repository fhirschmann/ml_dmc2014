...
plot(rownames(tbl),tbl[,1], type="l", xlab="months", ylab="popularity of color in percent (of all colors)", col="brown", ylim=c(0,1))
lines(rownames(tbl), tbl[, 2], col="red")
lines(rownames(tbl), tbl[, 3], col="pink")   #other
lines(rownames(tbl), tbl[, 4], col="black")
lines(rownames(tbl), tbl[, 5], col="yellow")
lines(rownames(tbl), tbl[, 6], col="blue")   
lines(rownames(tbl), tbl[, 7], col="grey")
lines(rownames(tbl), tbl[, 8], col="green")
lines(rownames(tbl), tbl[, 9], col="orange") #white
```
